...
const Aside = () => {
  ...
  return (
    <>
      <AOSWrapper>
        <div className="w-full bg-[#fafcff] overflow-hidden  min-h-screen flex flex-col items-center justify-center">
          {/* <Canvas /> */}
          <div
            data-aos="fade-down"
            data-aos-duration="1500"
            className="fixed z-40 top-6 titles text-[#333] text-2xl "
          >
            Wedding Invitation
          </div>
          ...
          >
            ...
            <div className="absolute  rounded-full bg-gradient-to-t from-[#c3e6ec] via-transparent to-[#d0f0ff] top-0 z-30 w-full h-full" />
          </div>
          ...
          <div className="flex flex-col gap-9 items-center justify-center fixed bottom-16 z-30">
            ...
            <p className="titles text-[#333] py-0 text-2xl">
              10 September 2023
            </p>
          </div>
        </div>
