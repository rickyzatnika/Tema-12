    ...
    <>
      <AOSWrapper>
        <div className="w-full min-h-screen" id="wish">
          ...
          <div className="w-full pt-10 pb-24 relative overflow-y-scroll h-[95%] bg-gradient-to-b from-[#ffffff] to-[#e9f6ff]  pl-3 lg:px-10 ">
            <h2 className="text-zinc-500 alex text-lg">
              {posts?.length + 1}{" "}
              <span className="brush text-xl">Post Comment</span>
            </h2>
            <ol className=" p-8   ">
              <li className="w-full border-b pb-4 border-zinc-300">
                ...
                <span className="mb-1 text-md titles font-semibold leading-none text-zinc-600/80">
                  WebQodes Digital Invitation
                </span>
                <p
                  data-aos="fade-up"
                  data-aos-duration="1000"
                  className="mb-2 p-2 text-sm leading-relaxed lg:text-md  text-zinc-500 "
                >
            ...
            {posts?.map((post, i) => (
              <ol key={i} className="p-8  ">
                <li className="w-full border-b pb-4 border-zinc-300">
                  ...
                  <span className="mb-1 capitalize text-md titles font-semibold  text-zinc-600/80">
                    {post?.name}
                  </span>
                  ...
                  <p
                    data-aos="fade-up"
                    data-aos-duration="1000"
                    className="mb-4 p-2 text-sm leading-relaxed lg:text-md  text-zinc-500 "
                  >
                    {post?.comments}
                  </p>
                ...
                {!post?.reply ? (
                  <p
                    data-aos="fade-up"
                    data-aos-duration="1000"
                    className="text-sm italic text-zinc-500/80"
                  >
                    Belum ada balasan ...
                  </p>
                ) : (
