    ...
    <>
      <div className="w-fit  z-[999999]  fixed flex items-center gap-2 top-4 left-2 lg:left-4">
        <div
          ...
          className="cursor-pointer  rounded-full   w-fit  shadow-lg shadow-black/10  transition-all duration-700 delay-75 ease-linear  p-2 bg-gradient-to-tr from-[#FBFBFB] via-[#96daeb] to-[#FBFBFB]"
        >
          {!isPlay ? (
            <HiPlay
              size={25}
